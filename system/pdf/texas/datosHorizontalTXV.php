...
<body>
    ...
    * {
    ...
    .date-vehicle-make span, .vin-seller>span{
...
?>
    ...
    <div class="cont-contenido">
        <div class="cont-row-1">
            ...
            <h6 class="date-vehicle-make"><?php echo $year;?> <span><?php echo $make;?></span></h6>
            <div class="cont-date-expires">
                <p>Expires</p>
                <h5><?php echo  $fecha_transformada;?></h5>
            </div>

            
            <h6 class="vin-seller">VIN: <?php echo $vin_vehicle; ?><br><span class="cont-span-seller"><span class="span-seller">Seller: </span><?php echo $seller;?></span></h6>
