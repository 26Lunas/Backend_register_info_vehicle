...
include "datos_v_pdf_tag_georgia.php"; // Incluir el archivo que contiene el HTML a utilizar
...
$pdf->setPaper(array(0, 0, 105, 335), 'landscape');
...
// $pdf->stream('TAG-GEORGIA.pdf',  array('Attachment' => 0));

file_put_contents('TAG-GEORGIA-h2.pdf', $pdf->output());