...
include "datos_h_pdf_tag_georgia.php"; // Incluir el archivo que contiene el HTML a utilizar
...
$pdf->setPaper(array(0, 0, 280, 435), 'landscape');
...
file_put_contents('TAG-GEORGIA-h1.pdf', $pdf->output());
