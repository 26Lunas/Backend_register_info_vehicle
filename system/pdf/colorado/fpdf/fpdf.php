...
function Cella($w, $h=0, $txt='', $border=0, $ln=0, $align='', $fill=false, $link='')
{
    $k=$this->k;
...
//MultiCell with bullet
function MultiCellBltseg($w, $h, $blt, $txt, $border=0, $align='J', $fill=false)
{
	//Get bullet width including margins
	$blt_width = $this->GetStringWidth($blt)+$this->cMargin*2;
	...
	//Output bullet
	$this->Cell($blt_width,$h,$blt,1,'',$fill);
